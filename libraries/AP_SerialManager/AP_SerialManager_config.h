 ...
 */
#if SERIALMANAGER_NUM_PORTS > 12 || SERIALMANAGER_NUM_PORTS < 5
#define SERIALMANAGER_MAX_PORTS SERIALMANAGER_NUM_PORTS
#else
#define SERIALMANAGER_MAX_PORTS 12
#endif
...
// serial ports registered by AP_CH9434 will use IDs starting at 71 for the first port
#define AP_SERIALMANAGER_CH9434_PORT_1      71 // CH9434_S1_*
...
#endif
#ifndef HAL_HAVE_SERIAL10
#define HAL_HAVE_SERIAL10 (HAL_NUM_SERIAL_PORTS > 10)
#endif
#ifndef HAL_HAVE_SERIAL11
#define HAL_HAVE_SERIAL11 (HAL_NUM_SERIAL_PORTS > 11)
#endif
...
#endif
#ifndef HAL_HAVE_SERIAL10_PARAMS
#define HAL_HAVE_SERIAL10_PARAMS HAL_HAVE_SERIAL10
#endif
#ifndef HAL_HAVE_SERIAL11_PARAMS
#define HAL_HAVE_SERIAL11_PARAMS HAL_HAVE_SERIAL11
#endif
